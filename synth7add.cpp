...
public:
     ...
     AddSyn()
    {
     ...
     virtual void init() {
       ...
       createInternalTriggerParameter("freqStri1", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqStri2", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqStri3", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqLow1", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqLow2", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqUp1", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqUp2", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqUp3", 0.7, 0.0, 20.0);
       createInternalTriggerParameter("freqUp4", 0.7, 0.0, 20.0);
     }
...
//    AddSyn& pan(float v){ mPan.pos(v); return *this; }
    ...
    virtual void onProcess(AudioIOData& io) override {
        ...
        if(mEnvStri.done() && (mEnvFollow.value() < 0.001)) free();
    }
